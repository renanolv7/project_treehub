                ...
                <div class="p-6 space-y-4">
                    <div id="nome-row" class="info-row py-4 border-b border-gray-200">
                        ...
                        <div class="view-container edit-view hidden">
                            ...
                            <input type="text" id="nome" class="data-input mt-2 w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500" value="Renan Oliveira">
                            <div class="flex justify-end space-x-3 mt-4">
                                ...
                                <button class="save-btn px-6 py-2 bg-blue-600 text-white rounded-lg text-sm font-semibold hover:bg-blue-700 transition-colors">Salvar</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="email-row" class="info-row py-4 border-b border-gray-200">
                        ...
                        <div class="view-container edit-view hidden">
                            ...
                            <input type="email" id="email" class="data-input mt-2 w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500" value="teste@gmail.com">
                            <div class="flex justify-end space-x-3 mt-4">
                                <button class="cancel-btn px-6 py-2 border border-gray-300 rounded-lg text-sm font-semibold text-gray-700 hover:bg-gray-100 transition-colors">Cancelar</button>
                                <button class="save-btn px-6 py-2 bg-blue-600 text-white rounded-lg text-sm font-semibold hover:bg-blue-700 transition-colors">Salvar</button>
                            </div>
                    ...
                    <div id="celular-row" class="info-row py-4 border-b border-gray-200">
                        ...
                        <div class="view-container edit-view hidden">
                            ...
                            <input type="tel" id="celular" class="data-input mt-2 w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500" value="+55912345678">
                            <div class="flex justify-end space-x-3 mt-4">
                                <button class="cancel-btn px-6 py-2 border border-gray-300 rounded-lg text-sm font-semibold text-gray-700 hover:bg-gray-100 transition-colors">Cancelar</button>
                                <button class="save-btn px-6 py-2 bg-blue-600 text-white rounded-lg text-sm font-semibold hover:bg-blue-700 transition-colors">Salvar</button>
                            </div>
                    ...
                    <div class="info-row py-4 border-b border-gray-200">
                        ...
                        <div class="view-container edit-view hidden">
                            ...
                            <input type="password" id="senha" class="data-input mt-2 w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Digite a nova senha">
                            <div class="flex justify-end space-x-3 mt-4">
                                <button class="cancel-btn px-6 py-2 border border-gray-300 rounded-lg text-sm font-semibold text-gray-700 hover:bg-gray-100 transition-colors">Cancelar</button>
                                <button class="save-btn px-6 py-2 bg-blue-600 text-white rounded-lg text-sm font-semibold hover:bg-blue-700 transition-colors">Salvar</button>
                            </div>
    ...
    <div id="confirmationModal" class="modal-hidden fixed inset-0 bg-gray-900 bg-opacity-60 flex items-center justify-center z-50">
        <div class="bg-white p-6 rounded-lg shadow-xl w-full max-w-sm">
            ...
            <div class="mt-6 flex justify-end space-x-4">
                ...
                <button id="modalConfirmBtn" class="px-6 py-2 bg-blue-600 text-white rounded-lg text-sm font-semibold hover:bg-blue-700 transition-colors">Sim, alterar</button>
            </div>
        </div>
    </div>
