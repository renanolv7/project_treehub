                ...
                <form id="form-cadastro" action="../services/cadastro_service.php" method="post">
                    ...
                    <div class="input-group space-y-4">
                        ...
                        <div>
                            ...
                            <input type="name" id="name" name="name" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-treehub-green focus:border-transparent" placeholder="Renan Vinicius de Oliveira">
                        </div>
                        
                        <!-- Email -->
                        <div>
                            <label for="email" class="block text-sm font-medium text-gray-700 mb-1">Email</label>
                            <input type="email" id="email" name="email" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-treehub-green focus:border-transparent" placeholder="teste@email.com">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="password" id="senha" name="senha" requiredminlength="6"class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-treehub-green focus:border-transparent" placeholder="••••••••">
                        </div>
                        ...
                        <div id="document-container">
                            ...
                            <input id="document-input" name="documento" type="text" required placeholder="00.000.000/0000-00" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-treehub-green focus:border-transparent">
                        </div>
                    </div>
                    <button class="w-full bg-[#2f4f1c] text-white py-2 mt-5 rounded-md border-2 border-transparent transition-all duration-300 hover:bg-white hover:text-[#2f4f1c] hover:border-[#2f4f1c]">
                        Cadastrar
                    </button>                    
                </form>    
            </div>
